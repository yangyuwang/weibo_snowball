...
class Weibo(object):
    ...
    def get_pics(self, weibo_info):
        ...
        if any(keyword in weibo_info["text"] for keyword in keywords):
    ...
    def download_files(self, file_type, weibo_type, wrote_count):
        ...
        try:
            ...
            file_dir = file_dir + os.sep + file_relative_path # + os.sep + describe
            if not os.path.isdir(file_dir):
                os.makedirs(file_dir)
